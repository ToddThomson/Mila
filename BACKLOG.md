...
- [ ] Fix the CUDA `fill_normal`/`fill_uniform` FP32-only gap (the deferred Consolidation training-only item) — it corrupts BF16 train-from-scratch init; the CUDA dtype counterpart to the `CpuTensorOps.Random` backend
