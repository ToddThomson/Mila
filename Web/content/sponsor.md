...
Qwen3-30B-A3B, gpt-oss-20b at FP4 — and an unquantized BF16 12B quality oracle on a single desk card.
...
performance box — at ~273 GB/s it sits below the development rig's RTX 4070 (~504 GB/s), so
