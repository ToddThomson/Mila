...
namespace Operations::Tests
{
    ...
    TEST_F( CudaFullyConnectedOpTests, BasicFunctionalityWithoutBias ) {
        ...
        Tensor<float, CudaDeviceMemoryResource> device_input( small_input_shape_ );
        auto device_weights = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( small_weight_shape_ );
        Tensor<float, CudaDeviceMemoryResource> device_output( small_output_shape_ );
        ...
        // Execute operation
        std::vector<std::shared_ptr<Tensor<float, CudaDeviceMemoryResource>>> params = { device_weights };
    ...
    TEST_F( CudaFullyConnectedOpTests, BasicFunctionalityWithBias ) {
        ...
        Tensor<float, CudaDeviceMemoryResource> device_input( small_input_shape_ );
        auto device_weights = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( small_weight_shape_ );
        auto device_bias = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( small_bias_shape_ );
        Tensor<float, CudaDeviceMemoryResource> device_output( small_output_shape_ );
        ...
        // Execute operation
        std::vector<std::shared_ptr<Tensor<float, CudaDeviceMemoryResource>>> params = { device_weights, device_bias };
        std::vector<std::shared_ptr<Tensor<float, CudaDeviceMemoryResource>>> output_state;
        OperationAttributes props;
    ...
    TEST_F( CudaFullyConnectedOpTests, CudaCpuEquivalence ) {
        ...
        Tensor<float, CudaDeviceMemoryResource> cuda_input( medium_input_shape_ );
        auto cuda_weights = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( medium_weight_shape_ );
        auto cuda_bias = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( medium_bias_shape_ );
        Tensor<float, CudaDeviceMemoryResource> cuda_output( medium_output_shape_ );
    ...
    TEST_F( CudaFullyConnectedOpTests, BackwardPass ) {
        ...
        Tensor<float, CudaDeviceMemoryResource> input( small_input_shape_ );
        Tensor<float, CudaDeviceMemoryResource> output( small_output_shape_ );
        Tensor<float, CudaDeviceMemoryResource> output_grad( small_output_shape_ );
        Tensor<float, CudaDeviceMemoryResource> input_grad( small_input_shape_ );

        auto weights = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( small_weight_shape_ );
        auto bias = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( small_bias_shape_ );
        auto weight_grad = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( small_weight_shape_ );
        auto bias_grad = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( small_bias_shape_ );
        ...
        // Forward pass first
        std::vector<std::shared_ptr<Tensor<float, CudaDeviceMemoryResource>>> params = { weights, bias };
        std::vector<std::shared_ptr<Tensor<float, CudaDeviceMemoryResource>>> output_state;
        std::vector<std::shared_ptr<Tensor<float, CudaDeviceMemoryResource>>> param_grads = { weight_grad, bias_grad };
        OperationAttributes props;
    ...
    TEST_F( CudaFullyConnectedOpTests, NonStandardShapes ) {
        ...
        auto device_bias = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( odd_bias_shape );
        Tensor<float, CudaDeviceMemoryResource> device_output( odd_output_shape );
    ...
    TEST_F( CudaFullyConnectedOpTests, NumericalStability ) {
        // Create test tensors
        Tensor<float, CudaDeviceMemoryResource> device_input( medium_input_shape_ );
        auto device_weights = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( medium_weight_shape_ );
        auto device_bias = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( medium_bias_shape_ );
        Tensor<float, CudaDeviceMemoryResource> device_output( medium_output_shape_ );
    ...
    TEST_F( CudaFullyConnectedOpTests, DeterministicBehavior ) {
        ...
        auto device_weights = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( medium_weight_shape_ );
        auto device_bias = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( medium_bias_shape_ );
        Tensor<float, CudaDeviceMemoryResource> device_output1( medium_output_shape_ );
        Tensor<float, CudaDeviceMemoryResource> device_output2( medium_output_shape_ );
    ...
    TEST_F( CudaFullyConnectedOpTests, Performance ) {
        ...
        Tensor<float, CudaDeviceMemoryResource> device_input( large_input_shape_ );
        auto device_weights = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( large_weight_shape_ );
        auto device_bias = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( large_bias_shape_ );
        Tensor<float, CudaDeviceMemoryResource> device_output( large_output_shape_ );
