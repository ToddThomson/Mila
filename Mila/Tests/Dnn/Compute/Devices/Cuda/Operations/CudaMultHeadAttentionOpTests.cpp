...
namespace Operations::Tests
{
    ...
    TEST_F( CudaMultiHeadAttentionOpTests, BackwardPass ) {
        ...
        auto device_weight_grad = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( weight_shape );
        auto device_bias_grad = std::make_shared<Tensor<float, CudaDeviceMemoryResource>>( bias_shape );
