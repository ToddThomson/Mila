...
namespace Components::Layers::Tests
{
    ...
    struct EncoderCudaTestData
    {
        ...
        LpeConfig config;
        std::shared_ptr<Lpe<DeviceType::Cuda, TensorDataType::INT32, TPrecision>> module;
        int64_t channels;
        int64_t max_seq_len;
        int64_t vocab_len;
            ...
            bool is_training = false )
        {
            ...
            d.module = std::make_shared<Lpe<DeviceType::Cuda, TensorDataType::INT32, TPrecision>>(
                name,
                d.config,
                Device::Cuda( 0 )
            );
    ...
    TEST_F( EncoderCudaTests, Constructor_WithoutDeviceId_AllowsDeferredContext_BuildThrows )
    {
        ...
        auto component = std::make_shared<Lpe<DeviceType::Cuda, TensorDataType::INT32, TensorDataType::FP32>>(
    ...
    TEST_F( EncoderCudaTests, Constructor_WithInvalidDevice_ThrowsInvalidArgument )
    {
        ...
        EXPECT_THROW(
            ( (void)std::make_shared<Lpe<DeviceType::Cuda, TensorDataType::INT32, TensorDataType::FP32>>(
                "invalid_device",
                cfg,
                Device::Cpu() ) ),
