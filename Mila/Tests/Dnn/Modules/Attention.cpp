...
namespace Dnn::Modules::Tests
{
    ...
    protected:
        void SetUp() override {
            ...
            channels_ = 768;
			num_heads_ = 12;
            input_shape_ = { batch_size_, sequence_length_, 3 * channels_ };
            has_bias_ = true;

            cpu_attention = std::make_unique<MilaDnn::Modules::Attention<float, MilaDnn::Compute::CpuMemoryResource>>(
                "cpu_attn", input_shape_, num_heads_ );
        ...
        std::unique_ptr<MilaDnn::Modules::Attention<float, MilaDnn::Compute::CpuMemoryResource>> cpu_attention;
