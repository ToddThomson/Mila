...
namespace Dnn::Modules::Tests
{
    ...
    protected:
        void SetUp() override {
            ...
            cpu_residual = std::make_unique<MilaDnn::Modules::Residual<float, MilaDnn::Compute::CpuMemoryResource>>(
                "cpu_residual", input_shape_ );
        ...
        std::unique_ptr<MilaDnn::Modules::Residual<float, MilaDnn::Compute::CpuMemoryResource>> cpu_residual;
