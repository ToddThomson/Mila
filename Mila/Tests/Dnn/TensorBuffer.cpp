...
namespace TensorBuffers::Tests
{
    ...
    TEST_F( TensorBufferTest, CpuBufferConstruction ) {
        ...
        Mila::Dnn::TensorBuffer<float, Mila::Dnn::Compute::CpuMemoryResource> buffer( 100 );
        EXPECT_EQ( buffer.size(), 100 );
        EXPECT_NE( buffer.data(), nullptr );

        // Construction with size and value
        Mila::Dnn::TensorBuffer<float, Mila::Dnn::Compute::CpuMemoryResource> buffer2( 100, 1.0f );
    ...
    TEST_F( TensorBufferTest, CpuBufferResize ) {
        Mila::Dnn::TensorBuffer<int, Mila::Dnn::Compute::CpuMemoryResource> buffer( 50 );
    ...
    TEST_F( TensorBufferTest, CpuBufferExternalMemory ) {
        ...
        Mila::Dnn::TensorBuffer<double, Mila::Dnn::Compute::CpuMemoryResource> buffer(
    ...
    TEST_F( TensorBufferTest, VerifyAlignment ) {
        TensorBuffer<float, Compute::CpuMemoryResource> cpu_buffer( 100 );
    ...
    TEST_F( TensorBufferTest, ExceptionHandling ) {
        ...
        EXPECT_THROW( (Mila::Dnn::TensorBuffer<int, Mila::Dnn::Compute::CpuMemoryResource>( 100, nullptr )), std::invalid_argument );

        // Very large allocation (should throw bad_alloc)
        EXPECT_THROW( (Mila::Dnn::TensorBuffer<int, Mila::Dnn::Compute::CpuMemoryResource>( std::numeric_limits<size_t>::max() )), std::overflow_error );

        // Overflow in aligned_size calculation in constructor
        EXPECT_THROW( (Mila::Dnn::TensorBuffer<int, Mila::Dnn::Compute::CpuMemoryResource>( (std::numeric_limits<size_t>::max() / sizeof( int )) + 1 )), std::overflow_error );

        // Overflow in aligned_size calculation in resize
        Mila::Dnn::TensorBuffer<int, Mila::Dnn::Compute::CpuMemoryResource> buffer( 10 );
    ...
    TEST_F( TensorBufferTest, DifferentTypes ) {
        ...
        Mila::Dnn::TensorBuffer<int, Mila::Dnn::Compute::CpuMemoryResource> int_buffer( 10 );
        Mila::Dnn::TensorBuffer<double, Mila::Dnn::Compute::CpuMemoryResource> double_buffer( 10 );
        Mila::Dnn::TensorBuffer<char, Mila::Dnn::Compute::CpuMemoryResource> char_buffer( 10 );
    ...
    TEST_F( TensorBufferTest, LargeBufferPerformance ) {
        ...
        Mila::Dnn::TensorBuffer<float, Mila::Dnn::Compute::CpuMemoryResource> buffer( large_size );
