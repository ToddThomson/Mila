...
namespace
{
    void printUsage()
    {
        std::cout <<
            ...
            "      --instruct                 The model is instruction-tuned. Without it the\n"
            "                                 manifest says it is not, and consumers treat it\n"
            "                                 as a base model.\n"
            ...
            "                                 Load, run one greedy step over a fixed prompt,\n"
            "                                 and print a per-component NaN summary plus a\n"
            "                                 digest of the logits. Writes nothing. Run it\n"
            "                                 against two files that should hold the same\n"
            "                                 model and diff the output.\n"
