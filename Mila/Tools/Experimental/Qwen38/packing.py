...
The normative statement of this layout is Mila/Src/Experimental/Quantization/
CodebookPacking.ixx; this module must match it byte for byte, and the generated
fixture header lets the C++ tests prove that it does. The converter's packer will
build on these functions.

Regenerate the fixture after any layout change:
  python packing.py --emit-fixture ../../../Tests/Experimental/Quantization/CodebookOracle.Fixture.h
"""
