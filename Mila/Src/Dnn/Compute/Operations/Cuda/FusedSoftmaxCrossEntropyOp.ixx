...
namespace Mila::Dnn::Compute
{
    ...
    public:
        ...
        void forward(
            ...
            const TPrecision* logits = logits.raw_data();
            const int* targets = targets.raw_data();
            TPrecision* losses = losses.raw_data();
            ...
            TPrecision* probs = output_state[ 0 ]->raw_data();
        ...
        void backward(
            ...
            // Get pointers to raw data
            const int* targets = input2.raw_data();
            const TPrecision* dlosses = output_gradient.raw_data();
            TPrecision* dlogits = input1_gradient.raw_data();
            ...
            const TPrecision* probs = output_state[ 0 ]->raw_data();
