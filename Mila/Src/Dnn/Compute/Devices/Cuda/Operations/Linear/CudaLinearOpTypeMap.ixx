...
// DEPRECATED: We now use OperationTraits to resolve the Linear operation type based on 
//             DeviceType, TensorDataType and WeightQuantizationPolicy, so this module is no longer needed.
