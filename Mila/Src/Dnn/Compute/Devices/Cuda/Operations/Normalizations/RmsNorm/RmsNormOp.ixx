    ...
    namespace Detail
    {
        ...
        struct cuda_rmsnorm_impl<half>
        {
            ...
            static inline void forward(
                ...
                cudaStream_t stream )
            {
                cuda_rmsnorm_forward_fp16( Y, rstd, X, weight, bias, outer_size, inner_size, norm_dim, epsilon, stream );
            }
            ...
            static inline void backward(
                ...
                cudaStream_t stream )
            {
                cuda_rmsnorm_backward_fp16( dX, dweight, dbias, dY, X, weight, rstd, outer_size, inner_size, norm_dim, stream );
            }
        };
    }
