 ...
 * CrossEntropy loss function modules. Inherits from ModuleConfig CRTP base and adds
...
namespace Mila::Dnn
{
     ...
     */
    export class CrossEntropyConfig : public ModuleConfig<CrossEntropyConfig> {
    public:
        /**
         ...
         */
        void validate() const {
            ModuleConfig<CrossEntropyConfig>::validate();
