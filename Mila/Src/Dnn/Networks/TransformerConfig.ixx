...
export module Dnn.Networks.TransformerConfig;
...
namespace Mila::Dnn::Networks
{
    ...
    // REVIEW: To be removed. Each pretrained transformer type will have its own config/presets.

    /**
     * @brief Configuration class for Transformer based networks.
     *
