...
namespace Mila::ChatApp
{
    ...
    export inline constexpr std::array<ModelEntry, 8> kModelCatalog = { {
        { "gemma-12b",     ModelType::Gemma, ModelSize::B12, ModelPrecision::BF16, true,  QuantizationMode::FP4,  "gemma/gemma4_12b_it_bf16.bin",       "gemma/gemma_tokenizer.bin",  512 },
        { "llama-1b",      ModelType::Llama, ModelSize::B1,  ModelPrecision::BF16, true,  QuantizationMode::None, "llama/llama32_1b_instruct_bf16.bin", "llama/llama32_tokenizer.bin", 4096 },
        { "llama-3b",      ModelType::Llama, ModelSize::B3,  ModelPrecision::BF16, true,  QuantizationMode::None, "llama/llama32_3b_instruct_bf16.bin", "llama/llama32_tokenizer.bin", 4096 },
        { "llama-8b",      ModelType::Llama, ModelSize::B8,  ModelPrecision::BF16, true,  QuantizationMode::None, "llama/llama31_8b_instruct_bf16.bin", "llama/llama32_tokenizer.bin", 4096 },
        { "llama-1b-fp32", ModelType::Llama, ModelSize::B1,  ModelPrecision::FP32, true,  QuantizationMode::None, "llama/llama32_1b_instruct_fp32.bin", "llama/llama32_tokenizer.bin", 4096 },
        { "llama-3b-fp32", ModelType::Llama, ModelSize::B3,  ModelPrecision::FP32, true,  QuantizationMode::None, "llama/llama32_3b_instruct_fp32.bin", "llama/llama32_tokenizer.bin", 4096 },
        { "llama-8b-fp32", ModelType::Llama, ModelSize::B8,  ModelPrecision::FP32, true,  QuantizationMode::None, "llama/llama31_8b_instruct_fp32.bin", "llama/llama32_tokenizer.bin", 4096 },
        { "gpt2",          ModelType::Gpt,   ModelSize::B3,  ModelPrecision::FP32, false, QuantizationMode::None, "gpt2/gpt2_small_fp32.bin",           "gpt2/gpt2_tokenizer.bin",    1024 },
    } };
