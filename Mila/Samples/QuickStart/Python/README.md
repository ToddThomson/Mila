...
**A CUDA GPU.** The binding is CUDA-only. Gemma 4 12B FP4 wants a 12 GB card for a
useful context; Llama 3.2 3B BF16 is the smaller first run. Every sample loads at the
longest context your GPU can hold and prints it; `--context-length 4096` fixes one.
